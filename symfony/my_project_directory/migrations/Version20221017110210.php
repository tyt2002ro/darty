...
final class Version20221017110210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_throw (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, player_id INT NOT NULL, points INT NOT NULL, throw_order SMALLINT NOT NULL, INDEX IDX_7DA038B84D77E7D8 (game_id), INDEX IDX_7DA038B8C036E511 (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
